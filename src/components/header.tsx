...
const Header = () => {
  ...
  return (
    <>
      ...
      ></div>
      <header
        className={`fixed top-0 left-0 w-full flex flex-col items-center justify-between bg-background/80 z-40 px-4 md:px-24 py-2 transition-shadow duration-300 ${
          hasShadow ? "shadow-md" : ""
